...
for(a=0;a<19;a++)
{
	dgamma[k][a]=((gamma[d[k][0]][a]-gamma[d[k][1]][a])*t1/2+(gamma[d[k][6]][a]+gamma[d[k][8]][a]+gamma[d[k][14]][a]+gamma[d[k][16]][a]-gamma[d[k][7]][a]-gamma[d[k][9]][a]-C[d[k][15]]-gamma[d[k][17]][a])*t2/2)*(e[a][0]-u[k][0]);
