...
void wet::propcolg()
{
  ...
  gforce0=-u[k][0]*FgMx*gamma0-u[k][1]*FgMy*gamma0+4.0/27.0*u[k][0]*gradrhoMx+4.0/27.0*u[k][1]*gradrhoMy;
  gforce1=-u[k][0]*FgMx*gamma1-u[k][1]*FgMy*gamma1+1.0/27.0*u[k][0]*gradrhoMx+1.0/27.0*u[k][1]*gradrhoMy+FgM1*gamma1-1.0/27.0*gradrhoM1;
  gforce2=-u[k][0]*FgMx*gamma2-u[k][1]*FgMy*gamma2+1.0/27.0*u[k][0]*gradrhoMx+1.0/27.0*u[k][1]*gradrhoMy+FgM2*gamma2-1.0/27.0*gradrhoM2;
  gforce3=-u[k][0]*FgMx*gamma3-u[k][1]*FgMy*gamma3+1.0/27.0*u[k][0]*gradrhoMx+1.0/27.0*u[k][1]*gradrhoMy+FgM3*gamma3-1.0/27.0*gradrhoM3;
  gforce4=-u[k][0]*FgMx*gamma4-u[k][1]*FgMy*gamma4+1.0/27.0*u[k][0]*gradrhoMx+1.0/27.0*u[k][1]*gradrhoMy+FgM4*gamma4-1.0/27.0*gradrhoM4;
  gforce7=-u[k][0]*FgMx*gamma7-u[k][1]*FgMy*gamma7+1.0/108.0*u[k][0]*gradrhoMx+1.0/108.0*u[k][1]*gradrhoMy+FgM7*gamma7-1.0/108.0*gradrhoM7;
  gforce8=-u[k][0]*FgMx*gamma8-u[k][1]*FgMy*gamma8+1.0/108.0*u[k][0]*gradrhoMx+1.0/108.0*u[k][1]*gradrhoMy+FgM8*gamma8-1.0/108.0*gradrhoM8;
  gforce9=-u[k][0]*FgMx*gamma9-u[k][1]*FgMy*gamma9+1.0/108.0*u[k][0]*gradrhoMx+1.0/108.0*u[k][1]*gradrhoMy+FgM9*gamma9-1.0/108.0*gradrhoM9;
  gforce10=-u[k][0]*FgMx*gamma10-u[k][1]*FgMy*gamma10+1.0/108.0*u[k][0]*gradrhoMx+1.0/108.0*u[k][1]*gradrhoMy+FgM10*gamma10-1.0/108.0*gradrhoM10;
