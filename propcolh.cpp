...
void wet::propcolh()
{
	...
	*/
	...
	/*
	M1=1.0/6.0*M*(muh[d[d[k][0]][6]]+muh[d[d[k][0]][7]]+muh[d[d[k][0]][8]]+muh[d[d[k][0]][9]]+4.0*muh[d[d[k][0]][0]]
		+4.0*muh[d[d[k][0]][1]]+4.0*muh[d[d[k][0]][2]]+4.0*muh[d[d[k][0]][3]]-20.0*muh[d[k][0]])/(dt*dt);
	M2=1.0/6.0*M*(muh[d[d[k][1]][6]]+muh[d[d[k][1]][7]]+muh[d[d[k][1]][8]]+muh[d[d[k][1]][9]]+4.0*muh[d[d[k][1]][0]]
		+4.0*muh[d[d[k][1]][1]]+4.0*muh[d[d[k][1]][2]]+4.0*muh[d[d[k][1]][3]]-20.0*muh[d[k][1]])/(dt*dt);
	M3=1.0/6.0*M*(muh[d[d[k][2]][6]]+muh[d[d[k][2]][7]]+muh[d[d[k][2]][8]]+muh[d[d[k][2]][9]]+4.0*muh[d[d[k][2]][0]]
       	+4.0*muh[d[d[k][2]][1]]+4.0*muh[d[d[k][2]][2]]+4.0*muh[d[d[k][2]][3]]-20.0*muh[d[k][2]])/(dt*dt);
	M4=1.0/6.0*M*(muh[d[d[k][3]][6]]+muh[d[d[k][3]][7]]+muh[d[d[k][3]][8]]+muh[d[d[k][3]][9]]+4.0*muh[d[d[k][3]][0]]
		+4.0*muh[d[d[k][3]][1]]+4.0*muh[d[d[k][3]][2]]+4.0*muh[d[d[k][3]][3]]-20.0*muh[d[k][3]])/(dt*dt);
	M7=1.0/6.0*M*(muh[d[d[k][6]][6]]+muh[d[d[k][6]][7]]+muh[d[d[k][6]][8]]+muh[d[d[k][6]][9]]+4.0*muh[d[d[k][6]][0]]
		+4.0*muh[d[d[k][6]][1]]+4.0*muh[d[d[k][6]][2]]+4.0*muh[d[d[k][6]][3]]-20.0*muh[d[k][6]])/(dt*dt);
	M8=1.0/6.0*M*(muh[d[d[k][7]][6]]+muh[d[d[k][7]][7]]+muh[d[d[k][7]][8]]+muh[d[d[k][7]][9]]+4.0*muh[d[d[k][7]][0]]
		+4.0*muh[d[d[k][7]][1]]+4.0*muh[d[d[k][7]][2]]+4.0*muh[d[d[k][7]][3]]-20.0*muh[d[k][7]])/(dt*dt);
	M9=1.0/6.0*M*(muh[d[d[k][8]][6]]+muh[d[d[k][8]][7]]+muh[d[d[k][8]][8]]+muh[d[d[k][8]][9]]+4.0*muh[d[d[k][8]][0]]
		+4.0*muh[d[d[k][8]][1]]+4.0*muh[d[d[k][8]][2]]+4.0*muh[d[d[k][8]][3]]-20.0*muh[d[k][8]])/(dt*dt);
	M10=1.0/6.0*M*(muh[d[d[k][9]][6]]+muh[d[d[k][9]][7]]+muh[d[d[k][9]][8]]+muh[d[d[k][9]][9]]+4.0*muh[d[d[k][9]][0]]
		+4.0*muh[d[d[k][9]][1]]+4.0*muh[d[d[k][9]][2]]+4.0*muh[d[d[k][9]][3]]-20.0*muh[d[k][9]])/(dt*dt);
	*/
	/*
	if(mask[k]==1)
	
	{
		M0=1.0/6.0*M*(muh[d[k][7]]+muh[d[k][7]]+muh[d[k][9]]+muh[d[k][9]]+4.0*muh[d[k][1]]
	+4.0*muh[d[k][1]]+4.0*muh[d[k][2]]+4.0*muh[d[k][3]]-20.0*muh[k]);
		M7=M8;
		M9=M10;
		M3=1.0/6.0*M*(muh[d[d[k][2]][7]]+muh[d[d[k][2]][7]]+muh[d[d[k][2]][9]]+muh[d[d[k][2]][9]]+4.0*muh[d[d[k][2]][1]]
	+4.0*muh[d[d[k][2]][1]]+4.0*muh[d[d[k][2]][2]]+4.0*muh[d[d[k][2]][3]]-20.0*muh[d[k][2]]);
		M4=1.0/6.0*M*(muh[d[d[k][3]][7]]+muh[d[d[k][3]][7]]+muh[d[d[k][3]][9]]+muh[d[d[k][3]][9]]+4.0*muh[d[d[k][3]][1]]
	+4.0*muh[d[d[k][3]][1]]+4.0*muh[d[d[k][3]][2]]+4.0*muh[d[d[k][3]][3]]-20.0*muh[d[k][3]]);
	gammap1=1.0/9.0*(1.0+3.0*u[d[k][1]][0]+3.0*u[d[k][1]][0]*u[d[k][1]][0]-1.5*u[d[k][1]][1]*u[d[k][1]][1]);
	gammap7=1.0/36.0*(1.0+3.0*(u[d[k][7]][0]+u[d[k][7]][1]+u[d[k][7]][0]*u[d[k][7]][0]+u[d[k][7]][1]*u[d[k][7]][1])+9.0*u[d[k][7]][0]*u[d[k][7]][1]);
	gammap9=1.0/36.0*(1.0+3.0*(u[d[k][8]][0]-u[d[k][8]][1]+u[d[k][8]][0]*u[d[k][8]][0]+u[d[k][8]][1]*u[d[k][8]][1])-9.0*u[d[k][8]][0]*u[d[k][8]][1]);
	...
	{
		M0=1.0/6.0*M*(muh[d[k][6]]+muh[d[k][6]]+muh[d[k][8]]+muh[d[k][8]]+4.0*muh[d[k][0]]
	+4.0*muh[d[k][0]]+4.0*muh[d[k][2]]+4.0*muh[d[k][3]]-20.0*muh[k]);
		M8=M7;
		M10=M9;
		M3=1.0/6.0*M*(muh[d[d[k][2]][6]]+muh[d[d[k][2]][6]]+muh[d[d[k][2]][8]]+muh[d[d[k][2]][8]]+4.0*muh[d[d[k][2]][0]]
	+4.0*muh[d[d[k][2]][0]]+4.0*muh[d[d[k][2]][2]]+4.0*muh[d[d[k][2]][3]]-20.0*muh[d[k][2]]);
		M4=1.0/6.0*M*(muh[d[d[k][3]][6]]+muh[d[d[k][3]][6]]+muh[d[d[k][3]][8]]+muh[d[d[k][3]][8]]+4.0*muh[d[d[k][3]][0]]
	+4.0*muh[d[d[k][3]][0]]+4.0*muh[d[d[k][3]][2]]+4.0*muh[d[d[k][3]][3]]-20.0*muh[d[k][3]]);
	gammap2=1.0/9.0*(1.0-3.0*u[d[k][0]][0]+3.0*u[d[k][0]][0]*u[d[k][1]][0]-1.5*u[d[k][0]][1]*u[d[k][0]][1]);
	gammap8=1.0/36.0*(1.0+3.0*(-u[d[k][6]][0]+u[d[k][6]][1]+u[d[k][6]][0]*u[d[k][6]][0]+u[d[k][6]][1]*u[d[k][6]][1])-9.0*u[d[k][6]][0]*u[d[k][6]][1]);
	gammap10=1.0/36.0*(1.0+3.0*(-u[d[k][8]][0]-u[d[k][8]][1]+u[d[k][8]][0]*u[d[k][8]][0]+u[d[k][8]][1]*u[d[k][8]][1])+9.0*u[d[k][8]][0]*u[d[k][8]][1]);
